        ...
        <body>
          <div className='relative bg-main-mobile md:bg-main-tablet lg:bg-main-desktop h-max l-max font-IBM'>
            ...
            <div className='max-w-3xl pt-12 pl-6 mx-auto '>
              <p className='text-3xl font-bold'>equalizer</p>
            ...
            <div className=' rounded-lg mx-auto my-80 w-[375px] md:w-[696px]  lg:w-[1110px]  h-[600px] bg-black'>
              <div className='relative'>
                ...
                {/* Orange card */}
                <div className=' text-white p-14 absolute rounded-lg top-[420px] w-[375px] h-[625px] md:w-[400px] md:top-[150px] md:left-[239px]  lg:left-[557px] lg:top-[90px]  bg-[#FA7453]'>
            ...
            <div className='flex justify-center mb-12 lg:mb-0 mt-[500px] pb-[91px] lg:mt-64 '>
              ...
              <div className=' flex m-10 pb-5 flex-col space-y-10 justify-between lg:flex  lg:flex-row  w-[1110px] h-[79px] '>
                ...
                <div className='flex items-center space-x-[20px] md:absolute md:right-0  md:pr-20 md:pt-14 lg:static  '>
